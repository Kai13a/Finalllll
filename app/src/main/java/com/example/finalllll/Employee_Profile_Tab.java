...
public class Employee_Profile_Tab extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_profile_tab);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.right:
                startActivity(new Intent(Employee_Profile_Tab.this,Employee_Profile.class));
                break;
    ...
    private void logoutUser() {
        Intent mainActivity = new Intent(Employee_Profile_Tab.this, MainActivity.class);
